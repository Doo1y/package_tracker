...
# print("Dij:", find_shortest_path_dij(map_dij, "Seattle", "Washington
# D.C."))  # Dij: ['Seattle', 'San Francisco', 'Denver', 'Kansas City',
...
# print("Dij:", find_shortest_path_dij(simple_map_dij, "C", "F"))  # Dij:
# ['C', 'D', 'E', 'F']
